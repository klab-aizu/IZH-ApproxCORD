...
The evaluation is conducted for CORDIC iteration counts ranging from 4 to 16 across four HOMIN neuron behaviors: Regular Spiking, Intrinsically Bursting, Chattering, and Low-Threshold Spiking, enabling an analysis of how iterative CORDIC approximation affects spike timing accuracy.
